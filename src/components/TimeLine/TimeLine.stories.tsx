    ...
    timelineItems: [
      {
        ...
        description: {
          ...
          metadata: {
            authors: [{ name: 'Wikimedia Common', role: 'Author' }],
            license: 'CC BY-SA',
            licenseVersion: '3.0',
            title: 'Ada Lovelace',
          }
      ...
      },
      {
        ...
        description: {
          ...
          metadata: {
            authors: [{ name: 'Lorem Ipsum', role: 'Author' }],
            license: 'C',
  ...
  const args: TimeLineProps = {
    ...
    data: {
      ...
      titleSlide: {
        ...
        description: {
          params: {
            text: '<p>Star-crossed lovers from feuding kingdoms.</p>',
          }
        },
        appearance: {
      ...
      timelineItems: [
        ...
        },
        {
          ...
          description: {
            params: {
              text: '<p>According to the legends of the Tay peoples, Thục Chế (蜀制; Shǔ Zhì) sires <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/An_D%C6%B0%C6%A1ng_V%C6%B0%C6%A1ng\'>Thục Phán</a> (蜀泮; Shǔ Pàn) while living among the <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/%C3%82u_Vi%E1%BB%87t\'>Âu Việt</a> (甌越; Ōuyuè) peoples.</p>',
            }
          },
          startDate: '-275',
          appearance: { backgroundType: 'none' },
        },
        {
          ...
          description: {
            params: {
              text: '<p>A military campaign that concluded with a decisive victory by <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Qin_(state)\'>Qin</a> over <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Zhao_(state)\'>Zhao</a>. Despite the Zhao military surrendering, an estimated 450,000 captured soldiers were executed en masse by live burial. Zhao suffers a devastating loss that it could not not recover from.</p>',
            }
          },
          startDate: '-262',
          endDate: '-260',
        ...
        },
        {
          ...
          description: {
            params: {
              text: '<p>Thục Phán (18), along with an alliance of Âu Việt tribes, conquer the <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/H%E1%BB%93ng_B%C3%A0ng_dynasty\'>Hồng Bàng dynasty</a> of the <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/L%E1%BA%A1c_Vi%E1%BB%87t\'>Lạc Việt</a> (雒越; Luòyuè) peoples and establishes the kingdom of <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/%C3%82u_L%E1%BA%A1c\'>Âu Lạc</a>.</p>',
            }
          },
          startDate: '-257',
          appearance: { backgroundType: 'none' },
        ...
        },
        {
          ...
          description: {
            params: {
              text: '<p>Zhao Tuo is born in Zhao, in what is present-day <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Zhengding_County\'>Zhengding County</a>, Hebei Province, China.</p>',
            }
          },
          startDate: '-240',
          appearance: { backgroundType: 'none' },
        ...
        },
        {
          ...
          description: {
            params: {
              text: 'Zhao Tuo (12) would bear witness to the fall of his country to Qin. Within a few years, he will enlist (or will be drafted) and serve in the Qin military.',
            }
          },
          startDate: '-228',
          appearance: { backgroundType: 'none' },
        ...
        },
        {
          ...
          description: {
            params: {
              text: '<p>To support the &ldquo;pacification of the south&rdquo;, the Chinese complete the 36-km <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Lingqu\'>Ling Canal</a>, connecting the Xiang and Li rivers, facilitating material and troop logistics from Qin dynasty China to the southern frontier.</p>',
            }
          },
          startDate: '-214',
          appearance: { backgroundType: 'none' },
        },
        {
          ...
          description: {
            params: {
              text: '<p>After defeating the Nanyue/Nam Việt tribes, the Chinese military establish an administrative center at <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Panyu_District\'>Panyu</a>, in present-day <a target=\'_blank\' href=\'https://en.wikipedia.org/wiki/Guangzhou\'>Guangzhou</a>, presiding over the Nanhai Commandery. While launching a successive offensive against the Xi&rsquo;ou/Âu Tây tribes to the west, General Tu Sui is killed. The Qin court appoint Ren Xiao and Zhao Tuo (26) to lead another offensive. They successfully defeat the Xi&rsquo;ou/Âu Tây, and Ren Xiao becomes Viceroy of Nanhai. The Guilin and Xiang Commanderies are also established to reinforce Chinese presence in the Xi&rsquo;ou/Âu Tây lands.</p>',
            }
          },
          startDate: '-214',
          appearance: { backgroundType: 'none' },
        ...
        },
        {
          ...
          description: {
            params: {
              text: '<p>With the demise of the Qin dynasty, Zhao Tuo (36), still overseeing the Nanhai, Guilin, and Xiang commanderies, declares an independent kingdom of Nanyue / Nam Việt.</p>',
            }
          },
          startDate: '-204',
          appearance: { backgroundType: 'none' },
